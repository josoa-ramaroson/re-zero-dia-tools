...
$sql = "SELECT * FROM  $tb_rhpersonnel where statut='Operationnel' and idrhp NOT IN(SELECT idrh FROM $tb_rhpaie where anneepaie='$anneepaie' and moispaie='$moispaie') ORDER BY matricule ASC LIMIT ".$nb_affichage_par_page." OFFSET ".$_GET['debut'];  
