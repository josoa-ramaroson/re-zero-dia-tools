...
<div class="panel panel-primary">
  <div class="panel-heading">
    ...
    <a href="rapport_moisimp.php?mois=<? echo md5(microtime()).$mois;?>&annee=<? echo md5(microtime()).$annee; ?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a>
    
    Representation Graphique &gt;&gt;
    <a href="stat_graph_sclient.php?&mois=<? echo $mois;?>&annee=<? echo $annee; ?>" target="_blank"><img src="images/graphique.jpg" width="50" height="30"></a></h3>
  </div>
