...
?>
    <tr>
      <td height="32" align="center" bgcolor="#FFFFFF"><div align="left"><? echo $data['id_dem'];?></div>
      ...
      <td width="163"   style="background-color:#FFF;"><a href="app_bonachat_imp.php?<? echo md5(microtime());?>&id=<? echo md5(microtime()).$data['id_dem'];?>" target="_blank" class="btn btn-xs btn-success">Visualiser les ordres</a>
