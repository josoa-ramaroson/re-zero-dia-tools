...
?>
      ...
      <tr>
        ...
        <td><input name="impayee3" type="text" id="impayee3" value="<? echo $rows3['impayee']; ?>" size="30" readonly></td>
...
?>
      ...
      <tr>
        ...
        <td><input name="impayee2" type="text" id="impayee2" value="<? echo $rows3['Pre']; ?>" size="30" readonly></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><em>
          ...
          <input name="Pre" type="hidden" id="Pre" value="<? echo $rows3['Pre'];?>">
          <font color="#FF0000">
          <input name="puisct" type="hidden" id="puisct" value="<? echo $rows3['puisct']; ?>" />
          <input name="impayee" type="hidden" id="impayee" value="<? echo $rows3['impayee']; ?>" />
        </font></em></td>
