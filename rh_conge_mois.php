...
$sql = "SELECT * FROM $tb_rhconge_date  where MONTH(date_entre)=$mois and YEAR(date_entre)=$annee ORDER BY matricule ASC LIMIT ".$nb_affichage_par_page." OFFSET ".$_GET['debut'];  
