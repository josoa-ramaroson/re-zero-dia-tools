...
$sql = "SELECT * FROM $tb_rhconge_date  where MONTH(date_entre)=$mois and YEAR(date_entre)=$annee ORDER BY matricule ASC LIMIT ".$_GET['debut']." OFFSET ".$nb_affichage_par_page;  
