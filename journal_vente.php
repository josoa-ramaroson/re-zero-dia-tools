...
?>
<body>
<a href="journal_vente_liste.php?m1v=<?php echo md5(microtime()).$m1v;?>&m2q=<?php echo md5(microtime()).$m2q;?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a>
<p>
<?php
...
and c.ville='$m1v' and  c.quartier='$m2q' ORDER BY f.id ASC  LIMIT ".$_GET['debut']." OFFSET ".$nb_affichage_par_page;  
