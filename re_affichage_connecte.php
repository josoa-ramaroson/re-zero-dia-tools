...
?>
   <tr>
     ...
     <? if (($_SESSION['niveau']==44) and ($data['statut']==4)) {?>
 <a href="re_affichage_confstatut.php?id=<? echo md5(microtime()).$data['id']; ?>&satut=<? $a='5';echo md5(microtime()).$a; ?>" onClick="return confirm('Etes-vous sûr que ce client est branché')" ; style="margin:5px"   class="btn btn-sm btn-danger" >Confirmation</a><? } else { } ?>
     </td>
   </tr>
   <?php
}
