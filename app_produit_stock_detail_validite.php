...
$np=substr($_REQUEST["np"],32);
 ...
 v.dateValidite  FROM  $tv_appproduit_dedate e   LEFT JOIN   $tv_appproduit_dsdate v  ON ( e.titre=v.titre) and (v.dateValidite=e.Validite) where e.titre='$np'  GROUP BY  e.Validite DESC LIMIT ".$nb_affichage_par_page." OFFSET ".$_GET['debut'];
