...
$sql = "SELECT * FROM $tbl_contact  where   RefLocalite='$RefLocalite'  and  (RefQuartier='$RefQuartier_1'  or RefQuartier='$RefQuartier_2' )  and statut='6' ORDER BY id ASC LIMIT ".$nb_affichage_par_page." OFFSET ".$_GET['debut'];  
