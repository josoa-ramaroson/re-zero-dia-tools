...
$sql = "SELECT * FROM  $tb_rhpersonnel where statut='Operationnel' and idrhp NOT IN(SELECT idrh FROM $tb_rhconge where anneeconge='$anneepaie') ORDER BY matricule ASC LIMIT ".$_GET['debut']." OFFSET ".$nb_affichage_par_page;  
