...
$sql = " SELECT * FROM $tbl_fact f , $tbl_contact c  where  c.email!='' and f.id=c.id and f.nserie=$nserie and f.fannee=$anneec ORDER BY f.id ASC  LIMIT ".$nb_affichage_par_page." OFFSET ".$_GET['debut'];  
