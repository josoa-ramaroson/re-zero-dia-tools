  ...
  <div class="panel-body">
    <form action="app_rapport_date.php" method="post" name="testform" id="form2">
      <table width="100%" border="0">
        <tr>
          <td width="32%"><? echo $date;?></td>
          <td width="23%"><? $P=strrev(chunk_split(strrev($rows2['prixt']),3," "));   echo $P;?></td>
          <td width="45%"> 
          <a href="app_rapport_date_liste.php?id=<? echo md5(microtime()).$date; ?>" class="btn btn-xs btn-success" target="_blank">Cliquez ici pour voir les details</a>          
          </td>
        </tr>
      </table>
    </form>
