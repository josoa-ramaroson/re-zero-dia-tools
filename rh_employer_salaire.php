...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">
      <input name="id" type="hidden" value="<? echo $datam['idrhp']; ?>" />
  ...
  <div class="panel-body">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td>IGR</td>
        <td><strong>
          <input name="igr" type="text" disabled="disabled" class="form-control" id="igr" value="<? echo $datam['igr']; ?>" size="20" readonly="readonly" />
        </strong></td>
      </tr>
      <tr>
        ...
        <td><strong>
          <input name="retraite" type="text" disabled="disabled" class="form-control" id="retraite" value="<? echo $datam['retraite']; ?>" size="20" readonly="readonly" />
        </strong></td>
      </tr>
      <tr>
        <td>Pret</td>
      ...
      <tr>
        ...
        <td>NET A PAYER </td>
        <td><strong>
          <input name="SNET" type="text" disabled="disabled" class="form-control" id="SNET" value="<? echo $datam['SNET']; ?>" size="20" readonly="readonly" />
        </strong></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><strong><span style="font-size:8.5pt;font-family:Arial">
          ...
          <a href="rh_employer_user.php?id=<? echo md5(microtime()).$datam['idrhp'];?>" class="btn btn-danger">FERMER</a></span></strong></td>
      </tr>
    </table>
  </div>
</div>
