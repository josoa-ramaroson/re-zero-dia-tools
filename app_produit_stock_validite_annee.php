...
if (!isset($_GET['debut'])) $_GET['debut'] = 0; 
 ...
 v.dateValidite  FROM  $tv_appproduit_dedate e   LEFT JOIN   $tv_appproduit_dsdate v  ON ( e.titre=v.titre) and (v.dateValidite=e.Validite) where  YEAR(e.Validite)=$annee  LIMIT ".$nb_affichage_par_page." OFFSET ".$_GET['debut'];
