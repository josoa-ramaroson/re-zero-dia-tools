...
?>
 <a href="rapport_recouvrementimp.php?an=<? echo md5(microtime()).$annee1rp;?>&ns=<? echo md5(microtime()).$nserie1;?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a></p>
 <p>&nbsp; </p>
