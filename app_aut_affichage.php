...
?>
<a href="app_aut_affichage_imp.php?a=<?php echo md5(microtime()).$mois;?>&b=<?php echo md5(microtime()).$annee;?>&c=<?php echo md5(microtime()).$service;?>" target="_blank"><img src="images/imprimante.png" width="50" height="30"></a>
