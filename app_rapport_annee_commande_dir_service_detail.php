...
?>
        <tr bgcolor=<?php echo "$bgcolor" ?>>
          ...
          <td width="15%"><?php $id_dem2=$rows2['id_dem']; $numero=le_bondecommande($id_dem2,$tbl_appcommande,$link); echo $numero; ?></td>
        </tr>
		  <?php
$numboucle++;
}

	function le_bondecommande($id_dem2,$tbl_appcommande,$link){
