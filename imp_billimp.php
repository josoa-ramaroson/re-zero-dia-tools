                ...
                <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="71%"><font color="#000000">
                      <? $client=substr($data5['nomprenom'],0,22); echo $client;?>
                    </font></td>
                  </tr>
                  <tr>
                    <td>Adresse :</td>
                    <td><span style="width: 40%; text-align: left"><span style="width:36%"><?
					$ville=substr($data5['ville'],0,15); echo $ville;?></span> <span style="width:36%"><? $quartier=substr($data5['quartier'],0,11); echo $quartier;?></span></span></td>
                  </tr>
                  <tr>
                    <td>ID Client :</td>
  ...
  <div class="panel-body">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <p><span style="width: 40%; text-align: left"><span style="width:36%"><? echo $data5['ville'];?></span> - <span style="width:36%"><? echo $data5['quartier'];?></span></span></p>
