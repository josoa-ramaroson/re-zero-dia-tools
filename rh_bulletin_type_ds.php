...
$sql = "SELECT * FROM $tb_rhpaie where anneepaie='$anneepaie' and moispaie='$moispaie' and direction='$m1d' and  service='$m2s' ORDER BY matricule ASC LIMIT ".$_GET['debut']." OFFSET ".$nb_affichage_par_page;  //DESC
