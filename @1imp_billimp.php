      ...
      <tr>
        <td><table width="93%" border="0.5" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="71%"><font color="#000000"><? $client=substr($data5['nomprenom'],0,18); echo $client;?></font></td>
          </tr>
          <tr>
            <td>Adresse :</td>
            <td><span style="width: 40%; text-align: left"><span style="width:36%"><? $ville=substr($data5['ville'],0,18); echo $ville;?></span> <span style="width:36%"><? echo $data5['quartier'];?></span></span></td>
          </tr>
          <tr>
            <td>ID Client :</td>
...
<p align="center">DATE LIMITE DE PAIEMENT : <b> <? echo  date("d-m-Y", strtotime($datcoupure)); ?> </b> &nbsp;&nbsp;</p>
  ...
  <div class="panel-body">
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <p>ADRESSE : <span style="width: 40%; text-align: left"><span style="width:36%"><? $ville=substr($data5['ville'],0,18); echo $ville;?></span> - <span style="width:36%"><? echo $data5['quartier'];?></span></span></p>
